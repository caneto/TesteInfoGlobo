...
import br.teste.edglobo.adapters.CommentAdapter;
import br.teste.edglobo.helper.InputValidatorHelper;
...
public class CommentActivity extends AppCompatActivity {
    ...
    class postCommentData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            String response = Extras.excutePost(Extras.URL(), urlParameters);
            return response;
        }
        @Override
    ...
    class fetchJsonData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            pageNum += 1;
            String response = Extras.excuteGet(Extras.URL()+"/get_comments.php?post_id="+ postId +"&page="+pageNum);
            return response;
        }
        @Override
        protected void onPostExecute(String result) {
