...
public class PostActivity extends AppCompatActivity {
    ...
    class fetchJsonData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            pageNum += 1;
            String response = Extras.excuteGet(Extras.URL()+"/category_posts.php?cat_id="+ catId +"&page="+pageNum+"&auth_key=");
            return response;
        }
        @Override
            ...
            try {
                ...
                if (status.contentEquals("false")){
                    ...
                    for (int i = 0; i < posts.length(); i++) {
                        ...
                        map.put("post_url", jsonObject.optString("post_url"));
